...
function buildPromptInputFromSummary(
  ...
  return {
    ...
    meetingOpening: asString(summary.meetingOpening),
    meetingAgenda: asString(summary.meetingAgenda),
    meetingGeneralInfo: asString(summary.meetingGeneralInfo),
    meetingAgreements: asString(summary.meetingAgreements),
    meetingClosing: asString(summary.meetingClosing),
